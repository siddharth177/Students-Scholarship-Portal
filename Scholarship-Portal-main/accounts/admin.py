...
class UserCreationForm(forms.ModelForm):
    ...
    class Meta:
        model = CustomUser
        fields = ['username', 'email', 'first_name', 'last_name', 'mobile', 'gender', 'caste', 'program', 'specialization', 'image']
...
class UserChangeForm(forms.ModelForm):
    ...
    class Meta:
        model = CustomUser
        fields = ['email', 'first_name', 'last_name', 'mobile', 'gender', 'caste', 'program', 'specialization', 'image']
...
class UserAdmin(BaseUserAdmin):
    ...
    list_display = ('username', 'first_name', 'last_name', 'mobile', 'is_superuser', 'id')
    list_filter = ( )

    fieldsets = (
        ('Login', {'fields': ('username', 'password')}),
        ('Profile', {'fields': (
            'first_name', 'last_name', 'mobile', 'email', 'gender', 'caste', 'program', 'specialization', 'image')}),
        ('Permissions', {'fields': (
