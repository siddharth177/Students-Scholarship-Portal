    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registration_number', models.CharField(blank=True, max_length=7, null=True, unique=True, validators=[django.core.validators.RegexValidator(message='Invalid Registration Number', regex='[a-zA-Z]{2}[0-9]{5}')], verbose_name='Registration number')),
