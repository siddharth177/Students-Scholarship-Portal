...
class CustomUser(AbstractBaseUser, PermissionsMixin):
    ...
    caste = models.CharField(max_length=255, default='NA', blank=True, null=True)
    program = models.CharField(max_length=255, default='NA', blank=True, null=True)
    specialization = models.CharField(max_length=255, default='NA', blank=True, null=True)
